    ...
    >
      ...
      <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
        <div className="animate-fade-in-up">
          ...
          <WordPullUp className="text-left text-4xl font-bold tracking-tight text-slate-800 md:text-6xl drop-shadow-none leading-[1.1]" words={content.headline} />
          <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-600 md:text-lg font-medium">{content.body}</p>
